...
solve input = (part1, part2)
  where
    (Right (ingredients, allergens)) = parseOnly ingredientsParser $ T.pack input
    part1 = show . length $ filterAllergens ingredients allergens
    part2 = intercalate "," . M.elems $ determineAllergens allergens
