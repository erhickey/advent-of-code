...
module Y2020.Day19 (solve) where
...
import qualified Data.Text as T (length, lines, pack)
...
solve input = (part1, part2)
  where
    ls = T.lines $ T.pack input
    (rules, _:msgs) = break (=="") ls
    ...
    part1 = show $ numValid ruleMap msgs
    part2 = show $ numValid p2Map msgs
